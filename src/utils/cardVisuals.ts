...
export const ART: Record<string, () => string> = {
  ...
  SC: () =>
    `<svg class="art" viewBox="0 0 100 130"><g filter="url(#goldGlow)"><circle cx="50" cy="58" r="36" fill="url(#gCoin)"/><text x="50" y="71" font-size="34" text-anchor="middle" fill="#a4650e" font-family="Georgia" font-weight="bold">$</text><text x="49" y="69.6" font-size="34" text-anchor="middle" fill="#ffe9a8" font-family="Georgia" font-weight="bold" opacity=".9">$</text><g clip-path="url(#coinClip)"><rect class="shineRect" x="30" y="18" width="12" height="84" fill="rgba(255,255,255,.55)"/></g></g><path d="M20 104 h60 v14 h-60 z" fill="url(#gRed)" filter="url(#artShadow)"/><text x="50" y="114.5" text-anchor="middle" font-size="9.5" fill="#ffe9a8" letter-spacing="1.5" font-family="Arial" font-weight="900">SCATTER</text></svg>`,
};
